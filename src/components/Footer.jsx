...
const Footer = () => {
  ...
  return (
    <Box as="footer" bg={bgColor} color={textColor} py={10} width="100%" margin="0">
      <Box maxW="100%" px={8} mx="auto">
        <Flex
        ...
        <Box pt={8} mt={6} borderTopWidth="1px" borderColor={borderColor} width="100%">
