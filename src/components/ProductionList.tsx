  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        if (videoId) {
          return <YouTubeThumbnail videoId={videoId} title={project.title} className="mb-4" />;
        }
        ...
        {(project.awards.length > 0 || project.events.length > 0) && (
          <div className="flex flex-wrap gap-1 mb-2">
            {project.awards.length > 0 && (
              <Badge
                variant="secondary"
                className="bg-yellow-100 text-yellow-700 dark:bg-yellow-900/20 dark:text-yellow-200 text-xs"
              >
            ...
            {project.events.length > 0 && (
              <Badge
                variant="outline"
                className="border-blue-200 text-blue-600 dark:border-blue-800 dark:text-blue-200 text-xs"
              >
