export default function HobbyPage() {
  const hobbies = [
    {
      title: "音楽",
      description:
        "SOUL'dOUT、ヤバイTシャツ屋さん、超能力戦士ドリアン、Creepy Nuts、キュウソネコカミ、四星球など、邦楽ロックやヒップホップを中心に聴いています。コーディング中のBGMとしても欠かせません。",
      icon: "🎵",
      featured: true,
    ...
    },
    {
      title: "アニメ",
      description:
        "様々なジャンルのアニメを楽しんでいます。ストーリー性の高い作品から日常系まで幅広く視聴し、キャラクターの心情や世界観に没入するのが好きです。",
      icon: "📺",
      featured: true,
      links: [
        {
    ...
    },
    {
      title: "ゲーム",
      description:
        "ノベルゲームやゆるい戦略ゲーとか箱庭系のゲームとか好きです！Steamでプレイ履歴も公開しています。",
      icon: "🎮",
    ...
    },
    {
      title: "漫画",
      description:
        "結構いろんなジャンルの漫画を読みます。特に、特定の業界に特化した作品が好きで、技術や社会の裏側を描いたものが面白いと感じます。IT系漫画についてもnoteで記事をまとめています。",
      icon: "📚",
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">趣味</h1>
